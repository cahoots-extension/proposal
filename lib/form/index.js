...
FormView.prototype.$send = function $send (callback) {
    ...
    data.authorInfo = this.model.authorInfo;
...
FormView.prototype.submit = function submit () {
    ...
    if (!this.isAuthorInfoValid()) {
        errors.authorInfo = true;
    }
...
FormView.prototype.setAuthorInfo = function setAuthorInfo (e) {
    this.$update('authorInfo', e.target.value);
};

FormView.prototype.isAuthorInfoValid = function isAuthorInfoValid () {
    return isURL(this.model.authorInfo);
};
...
FormView.prototype.setRole = function setRole (e) {
    this.$update('role', e.target.value);
};
